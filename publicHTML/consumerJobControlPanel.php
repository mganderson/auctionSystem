...
echo "<h2>Consumer Control Panel</h2>";


if($userPK == $currentContract->getConsumerFK()){
    //Display job info
    ...
    echo "
      ...
      <a href=\"/AuctionSystem/formHandlers/ConsumMarkCompleteHandler.php\" class=\"myButton\">Mark As Completed</a>
      </div>
      <br/>
      ";

    //if current contract is not disputed by the consumer
    if($currentContract->getDisputedByConsum() == 0){
        //display Flag as Disputed button
        echo "
      <br/>
      <div style=\"text-align:center;\">
      <a href=\"/AuctionSystem/formHandlers/ConsumMarkDisputedHandler.php\" class=\"redButton\">Flag as disputed</a>
      </div>
      <br/>
      ";
    }
    //Else display Unflag as disputed
      ...
      <a href=\"/AuctionSystem/formHandlers/ConsumUnmarkDisputedHandler.php\" class=\"myButton\">Un-flag as disputed</a>
      </div>
      <br/>
      ";
    }
    ...
    echo "
          ...
          UserID does not match Contract owner PK
          </h2></div>
         ";
}
